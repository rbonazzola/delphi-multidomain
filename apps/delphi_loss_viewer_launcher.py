"""
Launch the Delphi Loss Viewer.

Usage:
    python apps/delphi_loss_viewer_launcher.py [--server.port PORT] [extra streamlit args...]

Prints the SSH tunnel command, then replaces this process with:
    streamlit run apps/delphi_loss_viewer/app.py
"""
...
_APP = Path(__file__).resolve().parent / "delphi_loss_viewer" / "app.py"
_PORT_DEFAULT = 8501
